...
class CategoryScreen2 extends StatefulWidget {
  ...
  const CategoryScreen2({Key? key, required this.category}) : super(key: key);

  @override
  State<CategoryScreen2> createState() => _CategoryScreenState();
}

class _CategoryScreenState extends State<CategoryScreen2> {
  ...
  Future<List<Article>> fetchArticlesFromFlask(String category) async {
    final String serverAddress =
        'http://$ip:40733/category-news?category=technology';
  ...
  void navigateToArticleDetail(Article? article, String category) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        // Fluttertoast.showToast(
        //   msg: "Article marked as read in technology category.",
        //   toastLength: Toast.LENGTH_SHORT,
        //   gravity: ToastGravity.BOTTOM,
