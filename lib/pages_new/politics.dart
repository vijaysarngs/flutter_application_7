...
class CategoryScreen3 extends StatefulWidget {
  ...
  const CategoryScreen3({Key? key, required this.category}) : super(key: key);

  @override
  State<CategoryScreen3> createState() => _CategoryScreenState();
}

class _CategoryScreenState extends State<CategoryScreen3> {
  ...
  Future<List<Article>> fetchArticlesFromFlask(String category) async {
    final String serverAddress =
        'http://$ip:40733/category-news?category=politics';
